...
- **Backend:** Java 21, [Spring Boot](https://github.com/kthowns/mobidic-be) 3.4.3, Spring Data JPA, Spring Security,
  QueryDSL
- **Frontend:** [Flutter](https://github.com/kthowns/mobidic-fe) (
  Cross-Platform), [Android](https://github.com/kthowns/custom-voca) (Native Legacy)
...
- **멀티모듈 아키텍처 전환**: 서비스 확장성을 고려한 계층별 모듈 분리 및 의존성 역전(DIP) 적용
...
- **구현 로직:** 사용자 음성 데이터를 Flask 서버로 전송 ➡️ Whisper 모델(`base.en`)로 텍스트 변환 ➡️ **Damerau-Levenshtein Distance** 알고리즘으로 유사도 비교
  및 점수 산출
- **최적화:**
