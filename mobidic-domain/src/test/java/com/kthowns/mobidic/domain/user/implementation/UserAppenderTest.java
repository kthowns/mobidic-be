...
class UserAppenderTest {
    ...
    void appendTest() {
        ...
        // When
        User actualUser = target.append(email, nickname, password, role);
    ...
    void appendKakaoTest() {
        ...
        // When
        User actualUser = target.appendKakao(kakaoId, email, nickname, password, role);
