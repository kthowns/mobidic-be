...
class WordValidatorTest {
    ...
    @Test
    @DisplayName("validateExpressionDuplication 테스트")
    void validateExpressionDuplicationTest() {
        // Given
        // When
        // Then
    }
    ...
    @Test
    @DisplayName("validateExpressionUpdateDuplication 테스트")
    void validateExpressionUpdateDuplicationTest() {
        // Given
        // When
        // Then
    }
