...
class VocabularyValidatorTest {
    ...
    @Test
    @DisplayName("validateTitleAppendDuplication 테스트")
    void validateTitleAppendDuplicationTest() {
        // Given
        // When
        // Then
    }
    ...
    @Test
    @DisplayName("validateTitleUpdateDuplication 테스트")
    void validateTitleUpdateDuplicationTest() {
        // Given
        // When
        // Then
    }
