...
class WordReaderTest {
    ...
    void readDetailsByVocabularyIdTest() {
        ...
        // When
        List<WordDetail> actualDetails = target.readDetailsByVocabularyId(userId, vocabularyId, false);
    ...
    void readByIdAndUserIdTest_Success() {
        ...
        // When
        Word actualWord = target.readByIdAndUserId(wordId, userId);
    ...
    void readByIdAndUserIdTest_Fail() {
        ...
        // When & Then
        assertThatThrownBy(() -> target.readByIdAndUserId(wordId, userId))
