...
class StatisticReaderTest {
    ...
    void readByWordIdAndUserIdTest_Success() {
        ...
        // When
        WordStatistic actualStat = target.readByWordIdAndUserId(wordId, userId);
    ...
    void readByWordIdAndUserIdTest_Fail() {
        ...
        // When & Then
        assertThatThrownBy(() -> target.readByWordIdAndUserId(wordId, userId))
    ...
    void readByVocabularyIdTest() {
        ...
        // When
        List<WordStatistic> actualStats = target.readByVocabularyId(vocabularyId);
    ...
    void readByUserIdTest() {
        ...
        // When
        List<WordStatistic> actualStats = target.readByUserId(userId);
    ...
    void readVocabLearningRateTest_Success() {
        ...
        // When
        Double result = target.readVocabLearningRate(vocabularyId, userId);
    ...
    void readVocabLearningRateTest_Fail() {
        ...
        // When & Then
        assertThatThrownBy(() -> target.readVocabLearningRate(vocabularyId, userId))
                .isInstanceOf(ApiException.class)
