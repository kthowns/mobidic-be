...
class TermReaderTest {
    ...
    void readTermTest_WithVersion() {
        ...
        // When
        Term actualTerm = termReader.readTerm(type, version);
    ...
    void readTermTest_NullVersion() {
        ...
        // When
        Term actualTerm = termReader.readTerm(type, null);
    ...
    void readTermTest_Fail() {
        ...
        // When & Then
        assertThatThrownBy(() -> termReader.readTerm(type, version))
    ...
    void readActiveTermsTest() {
        ...
        // When
        List<SimpleTerm> actualTerms = termReader.readActiveTerms();
