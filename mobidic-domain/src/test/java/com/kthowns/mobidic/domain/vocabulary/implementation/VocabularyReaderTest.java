...
class VocabularyReaderTest {
    ...
    void readDetailsByUserIdTest() {
        ...
        // When
        List<VocabularyDetail> actualDetails = target.readDetailsByUserId(userId);
    ...
    void readByIdTest_Success() {
        ...
        // When
        Vocabulary actualVocab = target.readById(vocabId, userId);
    ...
    void readByIdTest_Fail() {
        ...
        // When & Then
        assertThatThrownBy(() -> target.readById(vocabId, userId))
    ...
    void readDetailByIdTest_Success() {
        ...
        // When
        VocabularyDetail actualDetail = target.readDetailById(userId, vocabId);
    ...
    void readDetailByIdTest_Fail() {
        ...
        // When & Then
        assertThatThrownBy(() -> target.readDetailById(userId, vocabId))
                .isInstanceOf(ApiException.class)
                .hasMessageContaining(GeneralResponseCode.NO_VOCAB.getMessage());
    }
    ...
    void existsByUserTest() {
        ...
        // When
        boolean exists = target.existsByUser(userId);
    ...
    void existsByIdAndUserTest() {
        ...
        // When
        boolean exists = target.existsByIdAndUser(vocabId, userId);
