...
class TermValidatorTest {
    ...
    void validateVersionDuplicationTest_Success() {
        ...
        // When & Then
        assertThatCode(() -> termValidator.validateVersionDuplication(type, version))
    ...
    void validateVersionDuplicationTest_Fail() {
        ...
        // When & Then
        assertThatThrownBy(() -> termValidator.validateVersionDuplication(type, version))
    ...
    void validateAgreementTest_Success() {
        ...
        // When & Then
        assertThatCode(() -> termValidator.validateAgreement(agreeTermIds))
                .doesNotThrowAnyException();
    }
    ...
    void validateAgreementTest_Fail_RequiredNotAgreed() {
        ...
        // When & Then
        assertThatThrownBy(() -> termValidator.validateAgreement(agreeTermIds))
                .isInstanceOf(ApiException.class)
