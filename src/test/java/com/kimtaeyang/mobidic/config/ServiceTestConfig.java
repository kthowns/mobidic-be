...
import com.kimtaeyang.mobidic.preset.repository.PresetWordRepository;
...
public class ServiceTestConfig {
    ...
    @Bean
    public PresetWordRepository presetWordRepository() {
        return Mockito.mock(PresetWordRepository.class);
    }
