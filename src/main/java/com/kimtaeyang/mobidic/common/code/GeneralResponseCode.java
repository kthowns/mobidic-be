...
public enum GeneralResponseCode implements ApiResponseCode {
    ...
    DUPLICATED_TERM_VERSION(HttpStatus.CONFLICT, "중복되는 버전의 약관입니다."),
    ...
    INVALID_TERM_ID_INCLUDED(HttpStatus.BAD_REQUEST, "유효하지 않은 약관이 포함되어 있습니다."),
    REQUIRED_TERM_NOT_AGREED(HttpStatus.BAD_REQUEST, "필수 항목에 동의하지 않았습니다."),
    ...
    EXTERNAL_SERVER_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "알 수 없는 오류가 발생했습니다.");
