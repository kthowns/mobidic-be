...
class VocabularyValidatorTest {
    ...
    void validateTitleAppendDuplicationTest_Success() {
        ...
        // When & Then
        assertThatCode(() -> vocabularyValidator.validateTitleAppendDuplication(title, userId))
    ...
    void validateTitleAppendDuplicationTest_Fail() {
        ...
        // When & Then
        assertThatThrownBy(() -> vocabularyValidator.validateTitleAppendDuplication(title, userId))
    ...
    void validateTitleUpdateDuplicationTest_Success() {
        ...
        // When & Then
        assertThatCode(() -> vocabularyValidator.validateTitleUpdateDuplication(title, vocabId, userId))
                .doesNotThrowAnyException();
    }
    ...
    void validateTitleUpdateDuplicationTest_Fail() {
        ...
        // When & Then
        assertThatThrownBy(() -> vocabularyValidator.validateTitleUpdateDuplication(title, vocabId, userId))
                .isInstanceOf(ApiException.class)
                .hasMessageContaining(GeneralResponseCode.DUPLICATED_TITLE.getMessage());
    }
}
